...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        def train_step(x_batch, y_batch):
            ...
            _, step, summaries, loss, accuracy, predict,scores,y = sess.run(
                [train_op, global_step, train_summary_op, cnn.loss, cnn.accuracy, cnn.predictions, cnn.scores,cnn.input_y],
                feed_dict)
